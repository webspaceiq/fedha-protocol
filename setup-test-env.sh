...
#cp -r node_modules/@aave/core-v3/artifacts/contracts/* temp-artifacts
...
#cp -r 'node_modules/@aave/deploy-v3/artifacts/@aave/safety-module/contracts/stake' temp-artifacts/deploy/stake
#cp -r 'node_modules/@aave/deploy-v3/artifacts/@aave/safety-module/contracts/proposals' temp-artifacts/deploy/proposals
